  ...
  return (
    selectedData && (
      <div
        ...
        style={{ display: "flex", justifyContent: "space-around" ,marginTop:'0.8rem'}}
      >
                  ...
                  {user ? (
                    ...
                    >
                      {element[index].title === "Backlog" ? (
                        <BiLoader style={{ fontSize: "10px" }} />
                      )
                        : element[index].title === "Todo" ? (
                          <FaRegCircle
                            style={{ fontSize: "10px", color: "#ddeded" }}
                          />
                        ) : element[index].title === "In progress" ? (
                          <BiAdjust
                            style={{ fontSize: "10px", color: "#f2d750" }}
                          />
          ...
          <>
            <div className="dashCardHeading flex-sb">
              <div className="leftView" style={{ fontSize: "15px", marginRight: "90px", wordSpacing: "4px" }}>
                ...
                <span style={{ fontSize: "15px", fontWeight: "lighter" }}>Done</span> <span style={{ fontSize: "13px", color: "#8F9997" }}>0</span>
              </div>
              <div className="rightView">
                <AiOutlinePlus />{" "}
                <span style={{ letterSpacing: "2px" }}>...</span>
            ...
            <div className="dashCardHeading flex-sb">
              <div className="leftView" style={{ fontSize: "15px", marginRight: "60px", wordSpacing: "4px" }}>
                ...
                <span style={{ fontSize: "15px", fontWeight: "lighter" }}>Cancelled</span> <span style={{ fontSize: "13px", color: "#8F9997" }}>0</span>
              </div>
              <div className="rightView">
                <AiOutlinePlus />{" "}
                <span style={{ letterSpacing: "2px" }}>...</span>
